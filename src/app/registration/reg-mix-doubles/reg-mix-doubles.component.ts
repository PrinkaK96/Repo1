...
@Component({
  selector: 'stupa-reg-mix-doubles',
  templateUrl: './reg-mix-doubles.component.html',
  styleUrls: ['./reg-mix-doubles.component.scss']
})
export class RegMixDoublesComponent {
  ...
  s: string = "";
  constructor(private dashboardService: DashboardService, private eventService: EventsService, private profileLettersService: ProfileLettersService, private azureLoggerService: MyMonitoringService,
    private messageService: MessageService, private commonApiService: CommonApiService, private encyptDecryptService: EncyptDecryptService) {
    this.innerWidth = window.innerWidth;
  }
  ngOnInit(): void {
    this._event_id = this.encyptDecryptService.decryptUsingAES256(
      localStorage.getItem('event_id')
    );
    this.getMixDoubleList();
  }
  //#region This method is used for select and de-select checkbox
  ...
  //#endregion
  //#region This method is used for get List of mix-doubles
  getMixDoubleList() {
    this._showLoader = true;
    this.dashboardService.getTeamsByParticipantIDAndEventId(4).subscribe({
      next: (data: any) => {
        this._teams = [];
        this._players = [];
        this._playersCopy = [];
  ...
  //#endregion
  //#region This method is used for get Payment
  payNow() {
  ...
  //#endregion
  //#region This method is used for Search
  findTeams() {
  ...
  //#endregion
  //#region This method is used for Get First Letters
