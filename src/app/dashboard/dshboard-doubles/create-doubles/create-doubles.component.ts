...
export class CreateDoublesComponent {
  ...
  constructor(private profileMenuService: ProfileMenuService, private eventService: EventsService, private messageService: MessageService, private encyptDecryptService: EncyptDecryptService, private azureLoggerService: MyMonitoringService,
    private formBuilder: FormBuilder, private dashboardService: DashboardService, private jsonDataCallingService: JsonDataCallingService,) {
  ...
  clearDropdown(event: any) {
    ...
    this._teamForm.controls['searched'].setValue('');
  }
