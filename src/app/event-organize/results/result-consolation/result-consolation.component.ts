...
@Component({
  selector: 'stupa-result-consolation',
  templateUrl: './result-consolation.component.html',
  styleUrls: ['./result-consolation.component.scss'],
  providers: [MessageService],
})
export class ResultConsolationComponent implements OnInit {
  ...
  getKnockoutTournament(eventId: any, categoryId: any) {
    this.fixtureService.getConsolationResult(eventId, categoryId, 'result').subscribe({
      next: (result: any) => {
